...
const PetaniLayout = () => {
  ...
  const menuItems = [
    ...
    { key: 'padi', icon: <AppstoreOutlined />, label: 'Management Padi' },
    { key: 'laporan', icon: <FileTextOutlined />, label: 'Laporan Penjualan' },
    { type: 'divider' },
    ...
    <Layout style={{ minHeight: '100vh' }}>
      ...
      <Layout>
        <Header style={{ padding: 0, background: colorBgContainer, display: 'flex', alignItems: 'center', boxShadow: '0 1px 4px rgba(0,21,41,.08)', zIndex: 1 }}>
          ...
          <h2 style={{ margin: 0, fontSize: '18px', color: '#333' }}>Dashboard Petani</h2>
        </Header>
